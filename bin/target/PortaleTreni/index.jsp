<html>
  ...
  <body>
<%--   <%  --%>
//     Utente utenteL = request.getAttribute("utenteL");
//     String username = (utenteL != null) ? utenteL.getUsername() : null;
<%-- %> --%>
    <div class="bg-indico-300 text-center py-2 text-sm">
...
<div class="bg-sky-500 text-white flex justify-between items-center p-4">
  <div class="flex space-x-4">
    ...
    <a href="list_treni" class="hover:underline">LISTA TRENI</a>
  </div>
  <div class="relative">
...
<option>FrecciaRossa</option>
    ...
    <a href="#" class="text-sm text-sky-800 hover:underline mt-4 block">Hai un codice promo?</a>
  </div>
</div>
